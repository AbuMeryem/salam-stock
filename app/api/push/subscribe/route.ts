 ...
 *  table push_subscriptions est stricte (anon ne peut pas INSERT
 *  directement). On utilise SUPABASE_SERVICE_ROLE_KEY pour bypass.
 *
 *  Le hook client envoie {p256dh, auth} (noms standard Web Push API).
 *  On stocke en `keys_p256dh` / `keys_auth` côté DB (voir migration
 *  0013_push_subscriptions). */
